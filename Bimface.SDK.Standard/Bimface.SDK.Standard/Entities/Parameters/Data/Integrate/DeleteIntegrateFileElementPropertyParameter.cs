...
namespace Bimface.SDK.Entities.Parameters.Data.Integrate
{
    ...
    public class DeleteIntegrateFileElementPropertyParameter : IntegrateParameter
    {
        #region Constructors

        public DeleteIntegrateFileElementPropertyParameter(long integrateId, string fileIdHash, string elementId) :
            base(integrateId)
        {

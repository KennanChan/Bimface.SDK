...
namespace Bimface.SDK.Entities.Parameters.Data.Integrate
{
    ...
    public class LookupIntegrateFileElementPropertyParameter : IntegrateParameter
    {
        #region Constructors

        public LookupIntegrateFileElementPropertyParameter(long integrateId, string fileIdHash, string elementId) :
            base(integrateId)
        {

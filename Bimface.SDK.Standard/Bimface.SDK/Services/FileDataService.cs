...
namespace Bimface.SDK.Services
{
    internal class FileDataService : HttpService, IFileDataService
    {
        ...
        public Task<Property> LookupElementsCommonProperty(LookupFileElementsCommandPropertyParameter parameter)
        {
            return FetchAsync<Property, LookupFileElementsCommandPropertyParameter>(parameter);
        }
